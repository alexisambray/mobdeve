...
/*
        ...
        foodplace1.put("name", "Jus & Jerry's EGI Taft");
        foodplace1.put("type", "Food Place");
        foodplace1.put("rating", "5 stars");
        foodplace1.put("features", "Not air-conditioned");

        Map<String, Object> foodplace2 = new HashMap<>();
        foodplace2.put("name", "Ate Rica's Bacsilog DLSU Branch");
        foodplace2.put("type", "Food Place");
        foodplace2.put("rating", "5 stars");
        foodplace2.put("features", "Not air-conditioned");


        firestore.collection("places").document("placedocu1").set(dlsuplace1);
        firestore.collection("places").document("placedocu2").set(dlsuplace2);
        firestore.collection("places").document("placedocu3").set(foodplace1);
        firestore.collection("places").document("placedocu4").set(foodplace2);*/
    }
